...
Также в разных источниках можно встретить `geom_bar()`, который преобразует в столбчатую диаграмму неаггрегированный вектор значений:
